...
class CustomUserAdmin(UserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal Info', {'fields': ('first_name', 'middle_name', 'last_name', 'user_type')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'first_name', 'middle_name', 'last_name', 'user_type', 'password1', 'password2', 'is_staff', 'is_active')}
        ),
    )
    ...
    def save_model(self, request, obj, form, change):
        # Generate username automatically from last_name, first_name, middle_name
